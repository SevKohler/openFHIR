package com.medblocks.openfhir.kds.vitalstatus;
...
public class VitalstatusToOpenEHRTest extends KdsTest {

    final String MODEL_MAPPINGS = "/kds_new/";
    final String CONTEXT = "/kds_new/projects/org.highmed/KDS/vitalstatus/KDS_Vitalstatus.context.yaml";
    ...
    public void assertToOpenEHRDetailedFields() {
        final Composition composition =
                fhirToOpenEhr.fhirToCompositionRm(context, getTestBundle(FHIR_INPUTS[0]), operationaltemplate);
        final JSONObject actual = new JSONObject(new CanonicalJson().marshal(composition));
