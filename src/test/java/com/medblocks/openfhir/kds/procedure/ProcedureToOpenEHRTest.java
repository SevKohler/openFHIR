...
import com.medblocks.openfhir.OptCompositionValidator;
...
public class ProcedureToOpenEHRTest extends KdsTest {
    ...
    @SneakyThrows
    private void assertCompositionIgnoringVolatileProcedureTime(final Composition composition, final String expectedPath) {
        ...
        final Composition expectedComposition = JacksonUtil.getObjectMapper().readValue(getFile(expectedPath), Composition.class);
    ...
    public void assertToOpenEHRLegacyFlatDetails() {
        final JsonObject jsonObject = fhirToOpenEhr.fhirToFlatJsonObject(
                context, getTestBundle("/kds/procedure/toOpenEHR/input/KDS_Prozedur_bundle.json"), operationaltemplate);
